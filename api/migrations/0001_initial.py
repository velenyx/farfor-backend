    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.IntegerField(blank=True, null=True, validators=[django.core.validators.RegexValidator(message='Число должно быть положительным', regex='^[0-9.]+$')], verbose_name='Вес')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='recalls/files/', verbose_name='Файл')),
            ],
            options={
                'verbose_name': 'Отзыв',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='buckets', to='api.modification', verbose_name='Товар')),
            ],
            options={
